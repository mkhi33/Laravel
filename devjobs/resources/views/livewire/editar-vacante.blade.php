<form class="md:w-1/2 space-y-5 " wire:submit.prevent='editarVacante'>
    ...
    <div>
        <x-label for="categoría" :value="__('Categoría')" />
    ...
    <div>
        ...
        <x-input id="empresa" class="block mt-1 w-full" type="text" wire:model="empresa" :value="old('empresa')" placeholder="Nombre de la empresa" />
        @error('empresa')
            <livewire:mostrar-alerta :message="$message"/>
        @enderror
    </div>
    <div>
        <x-label for="utimo_dia" :value="__('Último día para postularse')" />
        <x-input id="utimo_dia" class="block mt-1 w-full" type="date" wire:model="ultimo_dia" :value="old('utimo_dia')" />
        @error('ultimo_dia')
            <livewire:mostrar-alerta :message="$message"/>
        @enderror
    </div>
    ...
    <div>
        <x-label for="imagen_nueva" :value="__('Imagen')" />
