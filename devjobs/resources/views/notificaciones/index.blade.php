                        ...
                        @forelse ($notificaciones as $notificacion)
                            <div class="p-5  lg:flex lg:justify-between lg:items-center">
                                <div>
                                    ...
                                    <p >Hace: <span class="font-bold">{{$notificacion->created_at->diffForHumans()}}</span></p>
                                </div>
                                <div class="mt-5 lg:mt-0">
                                    <a class="bg-indigo-500 p-3 text-sm uppercase font-bold text-white rounded-lg" href="">Ver candidatos</a>
                                </div>
                            </div>
